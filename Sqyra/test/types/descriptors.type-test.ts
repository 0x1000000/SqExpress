...
const asCollision = defineTable({ schema: "dbo", name: "AsCollision", columns: { as: column(sqlType.int32) } });
const escapedAs: ColumnValue<typeof asCollision.$as> = 1;
void [idAlias, idName, id, name, version, directId, escapedColumns, escapedName, escapedAs, aliasTable, calledAliasName, automatic];
