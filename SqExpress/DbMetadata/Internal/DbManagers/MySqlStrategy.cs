...
internal class MySqlDbStrategy : DbStrategyBase
{
    ...
    {
        var columns = await this.LoadColumns();

        var (foreignKeys, fkNames, pk) = await this.LoadConstrains();
        ...
        var indexes = await Select(
            ...
            .From(tStatistics)
            .Where(this.GetTableFilter(tStatistics))
        ...
        LoadConstrains()
    {
        ...
        return Select(
            ...
            .Where(this.GetTableFilter(tColumnUsage) & tTableConstraints.ConstraintType.In("PRIMARY KEY", "FOREIGN KEY"))
    ...
    {
        return tColumns.TableSchema == this._databaseName;
    }
}
