...
using SqExpress.DbMetadata.Internal.DbManagers.MsSql.Tables;
using SqExpress.DbMetadata.Internal.Model;
using SqExpress.SqlExport;
using SqExpress.Syntax.Boolean;
using static SqExpress.SqQueryBuilder;

namespace SqExpress.DbMetadata.Internal.DbManagers.MsSql;
...
internal class MsSqlDbStrategy : DbStrategyBase
{
    ...
    public override DefaultValue? ParseDefaultValue(string? rawColumnDefaultValue, ColumnType columnType)
    {
        ...
        if (columnType is BooleanColumnType && TryGetDefaultValue(rawColumnDefaultValue, IntDefRegEx, DefaultValueType.Bool, out var result))
        {
        ...
        if (TryGetDefaultValue(rawColumnDefaultValue, IntDefRegEx, DefaultValueType.Integer, out result))
        {
            return result;
        }
    ...
    private Task<List<ColumnRawModel>> LoadColumns()
    {
        ...
        var cIsIdentity = CustomColumnFactory.Int32("Extra");
