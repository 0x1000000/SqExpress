...
public class ExprDeserializer
{
    ...
    private IExpr DeserializeInternal<TNode>(TNode rootElement, IExprReader<TNode> reader)
    {
        ...
        switch (typeTag)
        {
            ...
            case "JsonArray": return new ExprJsonArray(items: GetSubNodeList<TNode, ExprValue>(rootElement, reader, "Items"));
            case "JsonMember": return new ExprJsonMember(value: GetSubNode<TNode, ExprValue>(rootElement, reader, "Value"), name: ReadString(rootElement, reader, "Name"));
            case "JsonNull": return ExprJsonNull.Instance;
            case "JsonObject": return new ExprJsonObject(members: GetSubNodeList<TNode, ExprJsonMember>(rootElement, reader, "Members"));
            case "JsonOutputColumn": return new ExprJsonOutputColumn(value: GetSubNode<TNode, IExprSelecting>(rootElement, reader, "Value"), jsonPath: ReadString(rootElement, reader, "JsonPath"));
            case "JsonQuery": return new ExprJsonQuery(document: GetSubNode<TNode, ExprValue>(rootElement, reader, "Document"), path: ReadString(rootElement, reader, "Path"));
            case "JsonRemove": return new ExprJsonRemove(document: GetSubNode<TNode, ExprValue>(rootElement, reader, "Document"), path: ReadString(rootElement, reader, "Path"));
            case "JsonSet": return new ExprJsonSet(document: GetSubNode<TNode, ExprValue>(rootElement, reader, "Document"), value: GetSubNode<TNode, ExprValue>(rootElement, reader, "Value"), path: ReadString(rootElement, reader, "Path"));
            case "JsonTable": return new ExprJsonTable(document: GetSubNode<TNode, ExprValue>(rootElement, reader, "Document"), columns: GetSubNodeList<TNode, ExprJsonTableColumn>(rootElement, reader, "Columns"), alias: GetSubNode<TNode, ExprTableAlias>(rootElement, reader, "Alias"), path: ReadString(rootElement, reader, "Path"));
            case "JsonTableOrdinalColumn": return new ExprJsonTableOrdinalColumn(name: GetSubNode<TNode, ExprColumnName>(rootElement, reader, "Name"));
            case "JsonTableQueryColumn": return new ExprJsonTableQueryColumn(name: GetSubNode<TNode, ExprColumnName>(rootElement, reader, "Name"), path: ReadString(rootElement, reader, "Path"));
            case "JsonTableValueColumn": return new ExprJsonTableValueColumn(name: GetSubNode<TNode, ExprColumnName>(rootElement, reader, "Name"), sqlType: GetSubNode<TNode, ExprType>(rootElement, reader, "SqlType"), path: ReadString(rootElement, reader, "Path"));
            case "JsonValue": return new ExprJsonValue(document: GetSubNode<TNode, ExprValue>(rootElement, reader, "Document"), returningType: GetNullableSubNode<TNode, ExprType>(rootElement, reader, "ReturningType"), path: ReadString(rootElement, reader, "Path"));
            ...
            case "QueryAsJson": return new ExprQueryAsJson(query: GetSubNode<TNode, IExprQuery>(rootElement, reader, "Query"), withoutArrayWrapper: ReadBoolean(rootElement, reader, "WithoutArrayWrapper"), includeNullValues: ReadBoolean(rootElement, reader, "IncludeNullValues"));
            ...
            case "StringAgg": return new ExprStringAgg(expression: GetSubNode<TNode, ExprValue>(rootElement, reader, "Expression"), separator: GetSubNode<TNode, ExprValue>(rootElement, reader, "Separator"), orderBy: GetNullableSubNode<TNode, ExprOrderBy>(rootElement, reader, "OrderBy"));
