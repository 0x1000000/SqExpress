...
namespace SqExpress.GetStarted.Models
{
    public class CustomerData
    {
        ...
        {
            return new ExprAliasedColumn[]
            {
                table.CustomerId.As(prefix + table.CustomerId.ColumnName.Name),
                table.Type.As(prefix + table.Type.ColumnName.Name),
                table.Name.As(prefix + table.Name.ColumnName.Name)
            };
        }
