...
namespace SqExpress.GetStarted.Models
{
    public class UserName
    {
        ...
        public static ExprAliasedColumn[] GetColumnsWithPrefix(TableUser table, string prefix)
        {
            ...
            {
                table.UserId.As(prefix + table.UserId.ColumnName.Name),
                table.FirstName.As(prefix + table.FirstName.ColumnName.Name),
                table.LastName.As(prefix + table.LastName.ColumnName.Name)
            };
        }
