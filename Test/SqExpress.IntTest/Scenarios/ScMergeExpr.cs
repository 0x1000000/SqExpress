...
public class ScMergeExpr : IScenario
{
    public async Task Exec(IScenarioContext context)
    {
        ...
        var valTable = SqQueryBuilder
            .ValueTable(userNames.Take(10).Concat([new UserName((EntUser)(-1777), "New User", "Last Name")]), s => s.Set(tUser.UserId, (int)s.Item.Id).Set(tUser.FirstName, "Mode " + s.Item.FirstName));
