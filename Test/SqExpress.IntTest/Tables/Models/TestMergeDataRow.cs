...
public class TestMergeDataRow
{
    ...
    {
        return [table.Id, table.Value, table.Version];
    }

    //Auto-generated by SqExpress Code-gen util
    public static ExprAliasedColumn[] GetColumnsWithPrefix(TestMergeTmpTable table, string prefix)
    {
        return [table.Id.As(prefix + table.Id.ColumnName.Name), table.Value.As(prefix + table.Value.ColumnName.Name), table.Version.As(prefix + table.Version.ColumnName.Name)
        ];
    }
