...
public class UserName
{
    ...
    {
        return [table.UserId, table.FirstName, table.LastName];
    }

    //Auto-generated by SqExpress Code-gen util
    public static ExprAliasedColumn[] GetColumnsWithPrefix(TableItUser table, string prefix)
    {
        return [table.UserId.As(prefix + table.UserId.ColumnName.Name), table.FirstName.As(prefix + table.FirstName.ColumnName.Name), table.LastName.As(prefix + table.LastName.ColumnName.Name)
        ];
    }
