...
public class CustomerNameData
{
    ...
    {
        return [table.CustomerId, table.CustomerTypeId, table.Name];
    }

    //Auto-generated by SqExpress Code-gen util
    public static ExprAliasedColumn[] GetColumnsWithPrefix(CustomerName table, string prefix)
    {
        return [table.CustomerId.As(prefix + table.CustomerId.ColumnName.Name), table.CustomerTypeId.As(prefix + table.CustomerTypeId.ColumnName.Name), table.Name.As(prefix + table.Name.ColumnName.Name)
        ];
    }
