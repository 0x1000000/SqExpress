...
public class CompanyInitData
{
    ...
    {
        return [table.CompanyId, table.ExternalId, table.CompanyName];
    }

    //Auto-generated by SqExpress Code-gen util
    public static ExprAliasedColumn[] GetColumnsWithPrefix(TableItCompany table, string prefix)
    {
        return [table.CompanyId.As(prefix + table.CompanyId.ColumnName.Name), table.ExternalId.As(prefix + table.ExternalId.ColumnName.Name), table.CompanyName.As(prefix + table.CompanyName.ColumnName.Name)
        ];
    }
