...
public class Audit
{
    ...
    {
        return [table.Version, table.Created, table.Modified];
    }
    ...
    {
        return [table.Version.As(prefix + table.Version.ColumnName.Name), table.Created.As(prefix + table.Created.ColumnName.Name), table.Modified.As(prefix + table.Modified.ColumnName.Name)
        ];
    }
