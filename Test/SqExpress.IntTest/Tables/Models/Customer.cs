...
public class Customer
{
    ...
    {
        return [table.CustomerId, table.UserId, table.CompanyId];
    }

    //Auto-generated by SqExpress Code-gen util
    public static ExprAliasedColumn[] GetColumnsWithPrefix(TableItCustomer table, string prefix)
    {
        return [table.CustomerId.As(prefix + table.CustomerId.ColumnName.Name), table.UserId.As(prefix + table.UserId.ColumnName.Name), table.CompanyId.As(prefix + table.CompanyId.ColumnName.Name)
        ];
    }
