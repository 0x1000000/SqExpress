...
public class OrderDateCreated
{
    ...
    {
        return [table.OrderId, table.DateCreated];
    }

    //Auto-generated by SqExpress Code-gen util
    public static ExprAliasedColumn[] GetColumnsWithPrefix(TableItOrder table, string prefix)
    {
        return [table.OrderId.As(prefix + table.OrderId.ColumnName.Name), table.DateCreated.As(prefix + table.DateCreated.ColumnName.Name)
        ];
    }
